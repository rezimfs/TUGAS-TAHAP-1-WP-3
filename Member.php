...
class Member extends CI_Controller
{
    ...
    public function daftar()
    {
        ...
        $this->session->set_flashdata('pesan', '<div class="alert alert-success alert-message" role="alert">Akun Sudah Dibuat</div>');
        redirect(base_url());
    }
    ...
    public function ubahProfil()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            //Jika Terdapat Gambar yang di Upload
